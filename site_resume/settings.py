...
ACCOUNT_SIGNUP_VIEW = 'user.views.CustomSignupView'
ACCOUNT_LOGIN_VIEW = 'user.views.CustomLoginView'

ROOT_URLCONF = 'site_resume.urls'
...
WSGI_APPLICATION = 'site_resume.wsgi.application'
